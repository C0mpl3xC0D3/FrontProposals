  ...
  "inline-flex items-center justify-center rounded-full border px-2.5 py-1 text-xs font-semibold w-fit whitespace-nowrap shrink-0 [&>svg]:size-3 gap-1 [&>svg]:pointer-events-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-2 aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive transition-all overflow-hidden uppercase tracking-wide",
  {
    variants: {
      variant: {
        ...
        // Proposal statuses
        "status-draft":
          "border-slate-500/50 bg-slate-500/15 text-slate-200 shadow-sm",
        "status-open":
          "border-emerald-500/50 bg-emerald-500/15 text-emerald-200 shadow-sm",
        "status-closed":
          "border-red-500/50 bg-red-500/15 text-red-200 shadow-sm",
        "status-archived":
          "border-slate-600/50 bg-slate-600/15 text-slate-300",
        // Task statuses
        "status-todo":
          "border-amber-500/50 bg-amber-500/15 text-amber-200 shadow-sm",
        "status-progress":
          "border-blue-500/50 bg-blue-500/15 text-blue-200 shadow-sm",
        "status-done":
          "border-emerald-500/50 bg-emerald-500/15 text-emerald-200 shadow-sm",
      },
    },
